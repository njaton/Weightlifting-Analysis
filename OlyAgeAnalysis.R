...
GoldAge <- c(glu21, glu26, glu31, gab31, gan)

barplot(GoldAge, names.arg = c("Under 21", "21 - 26", "26 - 31", "Above 31", "Age Not Recorded"),
        main = "Gold Medal Winning Athletes (Male & Female)", ylab = "Amount of Medal Earning Athletes",
        xlab = "Age (In Years)", col = c("green"))

SilverAge <- c(slu21, slu26, slu31, sab31, san)

barplot(SilverAge, names.arg = c("Under 21", "21 - 26", "26 - 31", "Above 31", "Age Not Recorded"),
        main = "Silver Medal Winning Athletes (Male & Female)", ylab = "Amount of Medal Earning Athletes",
        xlab = "Age (In Years)", col = c("green"))

BronzeAge <- c(blu21, blu26, blu31, bab31, ban)

barplot(BronzeAge, names.arg = c("Under 21", "21 - 26", "26 - 31", "Above 31", "Age Not Recorded"),
        main = "Bronze Medal Winning Athletes (Male & Female)", ylab = "Amount of Medal Earning Athletes",
        xlab = "Age (In Years)", col = c("green"))
