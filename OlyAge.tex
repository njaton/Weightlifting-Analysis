...
\subsection{Figure: 1}
\centering
\includegraphics[scale=.5]{AverageAgeofMedalWinningAthletes}
\end{figure}
...
\subsection{Figure: 2}
\centering
\includegraphics[scale=.5]{MedalWinningAthletesByAge}
\end{figure}
...
\subsection{Figure: 4}
\centering
\includegraphics[scale=.5]{AgeOfFemaleGoldMedalWinningAthletes}
\end{figure}
